...
TYPES: gt_carrier_id   TYPE RANGE OF /dmo/carrier_id,
       gt_airport_from TYPE RANGE OF /dmo/airport_from_id,
       gt_airport_to   TYPE RANGE OF /dmo/airport_to_id,
       gt_flight_date  TYPE RANGE OF /dmo/flight_date,
       BEGIN OF gs_flights,
       ...
       gt_airport      TYPE STANDARD TABLE OF /DMO/I_Airport WITH EMPTY KEY,
...
CONSTANTS: gc_dynnr              TYPE sydynnr VALUE '1100',
           ...
           gc_transaction_code   TYPE c LENGTH 18 VALUE 'Z_SSVG_FLIGHTS_RAP',
