...
*&---------------------------------------------------------------------*
CLASS z_lcl_ssvg_view_rap DEFINITION.
  PUBLIC SECTION.
...
CLASS z_lcl_ssvg_view_rap IMPLEMENTATION.
  ...
  METHOD create_airport_popup.
    IF it_airport IS NOT INITIAL.
      LOOP AT it_airport INTO DATA(ls_airport).
        ...
        APPEND |{ TEXT-005 } { ls_airport-AirportID }| TO rt_popup.
        APPEND |{ TEXT-006 } { ls_airport-name }| TO rt_popup.
        APPEND |{ TEXT-007 } { ls_airport-city }| TO rt_popup.
        APPEND |{ TEXT-008 } { ls_airport-CountryCode }| TO rt_popup.
